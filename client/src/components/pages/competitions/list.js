...
function CompetitionsList() {
  ...
  return (
    <Container className={styles.page}>
      ...
      >
        If you delete competition all categories and cards related to this competition will be
        deleted too. Also you can&#39;t delete competition if it in progress. Finish the competition
        first.
      </Modal>
      <SettingsPopover
