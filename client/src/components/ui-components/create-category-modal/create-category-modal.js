...
import { TextField, Select, Divider, FormControl, InputLabel, MenuItem, Chip } from '@mui/material';
...
export default function CreateCategory({ open, handleClose, competitionId }) {
  ...
  return (
    ...
    >
      ...
      <ListFields items={womenSubCategories} handleChangeItems={setWomenSubCategories} gap={1} />
    </Modal>
  );
}
